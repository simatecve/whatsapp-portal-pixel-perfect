...
import { SidebarProvider, Sidebar, SidebarContent, SidebarHeader, SidebarFooter, SidebarRail, SidebarInset } from '@/components/ui/sidebar';
              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Gestione las integraciones y webhooks de sus sesiones de WhatsApp.
                  </p>
                </div>
              </div>
              <WebhooksList user={user} />
            </div>
          </div>
        </SidebarInset>
      </div>
